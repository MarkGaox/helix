...
public class DelayedRebalanceUtil {
  ...
  private static boolean isInstanceForcedToBeRebalancded(Long offlineOrDisabledTime, long delay,
    ...
    boolean isTimePresent = offlineOrDisabledTime != null && offlineOrDisabledTime > 0;
    long delayedInactiveTime = isTimePresent ? offlineOrDisabledTime + delay : Long.MAX_VALUE;
    return lastOnDemandRebalanceTimestamp != -1 && isTimePresent
        && offlineOrDisabledTime < lastOnDemandRebalanceTimestamp
